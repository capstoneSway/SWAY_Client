...
type FeedItemProps = {
  post?: any;
  isDetail?: boolean;
  onCommentPress?: () => void; // ← 이 줄 추가
  onDelete?: () => void;
  onLikePress?: () => Promise<void>;
  onScrapPress?: () => Promise<void>;
  onEdit?: () => void;
  onPressEdit?: (commentId: any, content: any) => void;
};

export default function CurrencyScreen({ post }: FeedItemProps) {
  // 모달 / 선택 상태
